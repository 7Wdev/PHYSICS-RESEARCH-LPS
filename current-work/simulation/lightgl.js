// The variable GL is the whole class.
var GL = (function()
  {
    var gl;
    var GL =
      {
        // Initialization
        // `GL.create()` creates a new WebGL context and augments it with more methods.
        // The alpha channel is disabled by default because it usually causes unintended transparencies in the canvas.
